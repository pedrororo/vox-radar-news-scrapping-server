import json
from src.repository.adapters.postgres.models.view_economia import ViewEconomia
...
class ViewEconomiaRepository:
  ...
  def bulk_create(self, bulkData):
    ...
    for data in bulkData:
      ...
      query = ViewEconomia.insert_many(list)

    query.execute()

  def truncate(self):
    print('Truncate table')
    ViewEconomia.truncate_table(restart_identity=True)
