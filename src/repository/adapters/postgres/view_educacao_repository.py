import json
from src.repository.adapters.postgres.models.view_educacao import ViewEducacao
from src.utils.utils import Utils

class ViewEconomiaRepository:
  ...
  def bulk_create(self, bulkData):
    ...
    for data in bulkData:
      ...
      query = ViewEducacao.insert_many(list)

    query.execute()

  def truncate(self):
    print('Truncate table')
    ViewEducacao.truncate_table(restart_identity=True)
