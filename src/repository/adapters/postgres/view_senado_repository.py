import json
from src.repository.adapters.postgres.models.view_senado import ViewSenado
from src.utils.utils import Utils

class ViewSenadoRepository:
  ...
  def bulk_create(self, bulkData):
    ...
    for data in bulkData:
      ...
      query = ViewSenado.insert_many(list)

    query.execute()

  def truncate(self):
    print('Truncate table')
    ViewSenado.truncate_table(restart_identity=True)
