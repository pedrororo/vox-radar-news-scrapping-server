import json
from src.repository.adapters.postgres.models.view_saude import ViewSaude
from src.utils.utils import Utils

class ViewSaudeRepository:
  ...
  def bulk_create(self, bulkData):
    ...
    for data in bulkData:
      ...
      query = ViewSaude.insert_many(list)

    query.execute()

  def truncate(self):
    print('Truncate table')
    ViewSaude.truncate_table(restart_identity=True)
